...
if (
    ...
    if ($stmt->execute()) {
        ...
        // Redirige a la misma página con un parámetro de error
        header("Location: ../htmlfiles/registeralms.html?error=true");
        exit();
    }
} else {
    // Redirige a la página de registro si no se enviaron datos
    header("Location: ../htmlfiles/registeralms.html");
    exit();
}
